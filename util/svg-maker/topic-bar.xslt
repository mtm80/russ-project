...
<xsl:stylesheet 
        ...
        <xsl:template match="/">
                ...
                <xsl:variable select="$doc-report//doc[@candidate='zhirinovskii']" name="candidate-docs"/>
                ...
                <svg height="600" viewBox="0 0 500 550">
                        <g transform="translate(40 370)">
                                <xsl:variable as="xs:double" name="max-pct" select="40"/>
                                ...
                                <xsl:variable as="xs:double" name="chart-width" select="count(distinct-values(//topic/@name)) * $bar-width * 1.6"/>
                                ...
                                <xsl:for-each-group select="//topic[@name]" group-by="@name">
                                        ...
                                        <xsl:variable as="xs:double" name="x-position" select="(position() - 1) * $bar-width * 1.6 + $bar-width div 3"/>
